  ...
  return (
    <div className="grid grid-cols-1 gap-6 px-2 py-4 md:grid-cols-2 md:gap-x-10">
          ...
          <div className="flex items-center  space-x-2 font-semibold text-white transition-colors duration-150 hover:text-blue-400">
            ...
            <p className="decoration-3 font-sm font-mono text-sm font-medium text-gray-900 underline">
          ...
          <div className="flex items-center  space-x-2 font-semibold text-white transition-colors duration-150 hover:text-blue-400">
            <OfficeBuildingIcon className="h-5 w-5 text-slate-500 " />
            <p className="font-sm font-mono text-sm font-medium text-gray-900 ">
